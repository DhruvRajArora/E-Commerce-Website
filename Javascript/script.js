try {
    ...
    tryInjectRosettaScript('front1.js', 'https://d201eyh6wia12q.cloudfront.net/translations2022/new-frontend/files/new-frontend.en.-1759101918.translations');
    })();
    (function() {
    ...
    script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-storefront.335dbbd5af884cf79d5c6c0e8752264e.min.js');
    document.getElementsByTagName('head')[0].appendChild(script);
    }
    ...
    script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-checkout.b6ba84b62af6052316cd85787eeafdd4.min.js');
    document.getElementsByTagName('head')[0].appendChild(script);
    ...
    window.Ecwid = {
    storefrontVersion: "2022-44846-gb9fa230a48088b",
    ...
    OnPageSwitch: new ep,
    signature: "92aeb366cb67a58e700d25f5e739b743-0",
    ...
    window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-210382959&ownerid=19015702&withoutLegacyCss=true' + cssUrlAddition;
    var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-210382959&ownerid=19015702&withoutLegacyCss=true' + cssUrlAddition;
    ...
    xInjectJs('https://d3dq8sxcny4hg.cloudfront.net/states.js?version=2022-44846-gb9fa230a48088b&callback=window.ecwid_states_data.loaded');
    ...
    window.ecwid_script_base="https://d3cy3u1txmkqs3.cloudfront.net/static/br/2022-44846-gb9fa230a48088b/";
    ...
    window.xnext_ownerId=19015702;
    window.Ecwid.publicToken = "public_J2emUEFpTxJiABLXGWVvQuRwC14ZVtvk",
    window.Ecwid.demo=false;
    window.Ecwid.cssUrl="https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-210382959&ownerid=19015702&withoutLegacyCss=true";
    ...
    var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=19015702";
    ecDataJsBaseUrl += "&lang=en";
    ecDataJsBaseUrl += "&token=595be97154464f71c37ae64636ace8eb2bfab43c";
    ...
    var tokenMap = {"ecwid-storefront":"public_J2emUEFpTxJiABLXGWVvQuRwC14ZVtvk"};
    ...
    a.async=1;a.src=g;if(Ecwid._isInteractiveEnabled() && m != null && m.parentNode != null)m.parentNode.insertBefore(a,m);else var h=100,k=setInterval(function(){ m = s.getElementsByTagName(o)[0]; if((/loaded|complete/.test(s.readyState)||0==h--) && m != null && m.parentNode != null)m.parentNode.insertBefore(a,m),clearInterval(k)},100)})(window,document,"script","ecom.js","eca");
    ...
    window.Ecwid.getAppPublicConfig = function(namespace) {
        var publicData = {"ecwid-degenerator-app":"{}","starter-site":"{}","ecwid-storefront":"{}"};
